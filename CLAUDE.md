...
- [ ] 2단계 (검증 통과 후): 등장인물 idea_brief→미리 채움 · 기획 생성에 idea_brief 전체 주입 · 시놉시스 기승전결 4단({ki,seung,jeon,gyeol} dict, episode.synopsis 컬럼은 합친 문자열)
- [ ] 3단계: 읽기 전용 뷰 보강
