...
### 최근 완료 (2026-08-25)
- [x] **P4 — 연작 입구 + 바이블 + 아웃라인** — 백엔드 10 API + SeriesPage + ProjectPage 연작 모달. 검증 27/27 ALL PASS. 배포 완료 (0171dd2)
...
### P4 코드 완료·배포·커밋됨 — 다음: 사용자 실사용 테스트 → P5
- **사용자 테스트 항목:** 연작 생성 → 바이블 품질 확인 → 아웃라인 편집(수정/병합/분할/from_no 재생성) → 모바일 → 피드백 반영 → P4 종료
