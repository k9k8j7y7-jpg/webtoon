...
- 제품 자산: products 테이블(step25). Gate3 제품 섹션(광고 전용) — 사진 업로드→비전 추출→일러스트 시트(1패킷, 플랜C). 컷 생성 시 시트 자동 참조+프롬프트 주입
...
- [x] 광고 2단계 제품 자산 (완료 2026-09-16, step25 products 테이블, Gate3 제품 섹션, 시트 생성+컷 참조 연동)
- [ ] **다음: 광고 2단계 실서버 테스트** (도도: ep30 게이트3 제품 섹션 → 제품 사진 시트 생성 → 컷 반영 확인) → 통과 후 3단계(제품 레이어 게이트5+내보내기)
