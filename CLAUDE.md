...
- 대본 생성: 단편=STANDALONE_SCRIPT_INSTRUCTION_ADDON(완결 필수·기승전결·예고 금지), 연작=SERIES_SCRIPT_INSTRUCTION_ADDON(훅에서 끊기). 공용 SYSTEM_INSTRUCTION + 분기 애드온 구조
...
- [ ] **다음: 광고 타입 + 제품 자산** → 광고 샘플 → 3화 잔여 → 시트 교체 → 4화
