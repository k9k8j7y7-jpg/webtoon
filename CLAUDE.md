...
- [ ] 2단계: 대시보드 (공지 바·헤더·내 웹툰 목록·접근 제어·개인정보처리방침·이용약관·FAQ)
- 메모: 구글 앱 테스트 모드 → 2단계 개인정보처리방침 배포 후 도도가 콘솔에서 게시. 네이버 검수는 오픈 준비 때. 토스 가맹 신청은 3단계 전
...
- [ ] 2층 2단계 대시보드 (진행 중: step18 마이그레이션→공지 바·헤더·목록·접근 제어·정책 페이지·FAQ)
- [ ] 0-5 도도 4화~ 제작 (병행)
